...
export interface ApiActiveThemeActiveTheme extends Struct.SingleTypeSchema {
  collectionName: 'active_themes';
  info: {
    description: '';
    displayName: 'Active Theme';
    pluralName: 'active-themes';
    singularName: 'active-theme';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::active-theme.active-theme'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    selectedTheme: Schema.Attribute.Relation<'oneToOne', 'api::theme.theme'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::active-theme.active-theme': ApiActiveThemeActiveTheme;
